...
#ifndef OPEN_WALKER_CORE_I_SCALAR_DIFFERENTIATION_H
#define OPEN_WALKER_CORE_I_SCALAR_DIFFERENTIATION_H
...
#endif // OPEN_WALKER_CORE_I_DIFFERENTIATION_ALGORITHM_H
