...
if("TRUE" STREQUAL "TRUE")
  set(rviz_camera_stream_SOURCE_PREFIX /home/marco/ros/workspaces/final_project/src/utilities/rviz_camera_stream)
  set(rviz_camera_stream_DEVEL_PREFIX /home/marco/ros/workspaces/final_project/src/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "https://github.com/lucasw/rviz_camera_stream " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Lucas Walter <lucasw_backwards@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_camera_stream' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marco/ros/workspaces/final_project/src/utilities/rviz_camera_stream/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rviz_camera_stream_EXPORTED_TARGETS ${${rviz_camera_stream_dep}_EXPORTED_TARGETS})
endforeach()
